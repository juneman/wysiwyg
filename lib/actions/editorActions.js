...
exports.setCloseAll = setCloseAll;
exports.setAceEditorConfig = setAceEditorConfig;
...
function setCloseAll() {
  return {
    type: _actionConstants2.default.EDITOR_SETTINGS_SET_CLOSE_ALL
  };
}

function setAceEditorConfig(aceEditorConfig) {
  return {
    type: _actionConstants2.default.EDITOR_SETTINGS_ACE_EDITOR,
    aceEditorConfig: aceEditorConfig
  };
}