...
var _ItalicButton = require('../icons/ItalicButton');
...
var Italic = function (_React$Component) {
  ...
  _createClass(Italic, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_ItalicButton2.default, _extends({ onClick: function onClick() {
    ...
    value: function handleFormat() {
      ...
      var newLocalState = localState.set('editorState', _draftJs.RichUtils.toggleInlineStyle(localState.get('editorState'), 'ITALIC'));
      onChange({
