...
var TextInputEditor = function (_React$Component) {
  _inherits(TextInputEditor, _React$Component);

  function TextInputEditor() {
    _classCallCheck(this, TextInputEditor);

    return _possibleConstructorReturn(this, (TextInputEditor.__proto__ || Object.getPrototypeOf(TextInputEditor)).apply(this, arguments));
  }

  _createClass(TextInputEditor, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        isEditing ? _react2.default.createElement(
          ...
          _react2.default.createElement('input', { type: 'text', className: 'form-control', 'data-field-id': zone.get('id'), required: isRequired, maxLength: maxLength, placeholder: placeholder })
        )
      );
    }
    ...
    value: function handleInputChange(e) {
      var placeholder = e.currentTarget.value;
      ...
      var newPersistedState = persistedState.set('placeholder', placeholder);
