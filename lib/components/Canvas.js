...
var Canvas = exports.Canvas = function (_React$Component) {
  ...
  _createClass(Canvas, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (!nextProps.aceEditorConfig.isEmpty() && !(0, _immutable.is)(nextProps.aceEditorConfig, this.props.aceEditorConfig)) {
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          allowedEditorTypes = _props2.allowedEditorTypes;
      ...
      console.log("canvasPositioncanvasPosition");
      console.log(canvasPosition);
      console.log(canvasPosition.toJS());
      ...
      var rowNodes = internalRows.size ? internalRows.map(function (row, i) {
        return row.get('zones') && row.get('zones').size ? _react2.default.createElement(_RowContainer2.default, {
          ...
          onClickAdd: function onClickAdd(addButtonPosition) {
            return _this2.toggleEditorSelector(addButtonPosition);
          },
    ...
    key: 'toggleEditorSelector',
    value: function toggleEditorSelector(addButtonPosition) {
      var showEditorSelector = this.props.showEditorSelector;
...
Canvas.propTypes = {
  ...
  aceEditorConfig: _propTypes2.default.instanceOf(_immutable.Map),
...
function mapStateToProps(state, ownProps) {
  return {
    ...
    aceEditorConfig: ownProps.aceEditorConfig ? (0, _immutable.fromJS)(ownProps.aceEditorConfig) : (0, _immutable.Map)(),
    ...
    showAddButton: (!ownProps.maxRows || ownProps.maxRows < state.rows.size) && !state.editor.get('disableAddButton') && !state.editor.get('isCanvasInEditMode') && state.rows.size && state.rows.every(function (row) {
