...
var EditorSelector = function (_React$Component) {
  ...
  _createClass(EditorSelector, [{
    ...
    value: function render() {
      ...
      var _addButtonPosition$to = addButtonPosition.toJS(),
          _addButtonPosition$to2 = _addButtonPosition$to.top,
          addBtnTop = _addButtonPosition$to2 === undefined ? 0 : _addButtonPosition$to2,
          _addButtonPosition$to3 = _addButtonPosition$to.left,
          addBtnLeft = _addButtonPosition$to3 === undefined ? 0 : _addButtonPosition$to3;

      var _canvasPosition$toJS = canvasPosition.toJS(),
          _canvasPosition$toJS$ = _canvasPosition$toJS.top,
          canvasTop = _canvasPosition$toJS$ === undefined ? 0 : _canvasPosition$toJS$,
          _canvasPosition$toJS$2 = _canvasPosition$toJS.left,
          canvasLeft = _canvasPosition$toJS$2 === undefined ? 0 : _canvasPosition$toJS$2;

      var _screenSize$toJS = screenSize.toJS(),
          _screenSize$toJS$heig = _screenSize$toJS.height,
          screenHeight = _screenSize$toJS$heig === undefined ? 0 : _screenSize$toJS$heig;

      var _position$toJS = position.toJS(),
          _position$toJS$height = _position$toJS.height,
          menuHeight = _position$toJS$height === undefined ? 0 : _position$toJS$height,
          _position$toJS$width = _position$toJS.width,
          menuWidth = _position$toJS$width === undefined ? 0 : _position$toJS$width,
          _position$toJS$top = _position$toJS.top,
          menuTop = _position$toJS$top === undefined ? 0 : _position$toJS$top;

      var _secondaryMenuPositio = secondaryMenuPosition.toJS(),
          _secondaryMenuPositio2 = _secondaryMenuPositio.height,
          secMenuHeight = _secondaryMenuPositio2 === undefined ? 0 : _secondaryMenuPositio2;

      var _formPosition$toJS = formPosition.toJS(),
          _formPosition$toJS$to = _formPosition$toJS.top,
          formTop = _formPosition$toJS$to === undefined ? 0 : _formPosition$toJS$to;

      var hasRoomToRenderBelow = addBtnTop + 300 < screenHeight ? true : false;

      var positionBelowBtn = {
        top: addBtnTop - canvasTop,
        left: addBtnLeft - canvasLeft - menuWidth / 2 + 20
      };

      var positionAboveBtn = {
        top: addBtnTop - canvasTop - menuHeight,
        left: addBtnLeft - canvasLeft - menuWidth / 2 + 20
      };

      var menuPosition = hasRoomToRenderBelow ? positionBelowBtn : positionAboveBtn;
            ...
            trimmedEditors.map(function (editor) {
              ...
              return _react2.default.createElement(
                ...
                { href: '#',
                  ...
                  onClick: editor.type === 'Form' ? function (e) {
