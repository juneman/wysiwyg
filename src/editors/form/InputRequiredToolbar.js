...
export default class InputRequiredToolbar extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleSave(e) {
    ...
    const newPersistedState = persistedState.set('isRequired', isRequired);
...
InputRequiredToolbar.propTypes = {
